...
class Agent():
    ...
    def act(self, states, add_noise):
        """Returns actions for both the agents as per current policy, corresponding to their respective states."""
    ...
    def learn(self, experiences, gamma, agent_number):
        ...
        # Construct next action vector relative to the agent
        if agent_number == 0:
    ...
    def soft_update(self, local_model, target_model, tau):
        ...
        ======
            ...
            (float) tau: interpolation parameter
        """
...
class OUNoise:
    ...
    def __init__(self, size, seed, mu=0.0, theta=OU_THETA, sigma=OU_SIGMA):
        ...
        Params
        ======
            (float) mu    : long-running mean
            (float) theta : speed of mean reversion
            (float) sigma : volatility parameter
        """
...
class ReplayBuffer:
    ...
    def __init__(self, action_size, buffer_size, batch_size, seed):
        ...
        Params
        ======
            (int) buffer_size: maximum size of buffer
            (int) batch_size: size of each training batch
        """
        self.action_size = action_size
    ...
    def sample(self):
        """For generalization, randomly sample a batch of experiences from the memory."""
    ...
    def __len__(self):
        """Return current size of the internal memory."""
